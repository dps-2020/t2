...
public class WithdrawalTest {
	...
	public void UpdateWithdrawal() {
		// Testing proper password and withdrawal amount updates account to correct new
		// balance. UAT 5.1, 5.3 & 5.4
	...
	/*
	 * @Test public void WithdrawalNotNegative() { //Testing withdrawals do not
	 * contain a negative amount. UAT 5.2 Withdrawal withdrawal = new
	 * Withdrawal("01002", "A1004", "-100"); //Assert.assertEquals("valid",
	 * withdrawal.validateWithdrawalAmount("-100"));
	 * Assert.assertEquals("Withdrawal amount cannot be negative",
	 * withdrawal.validateWithdrawalAmount(withdrawal.getWithdrawalAmount())); }
	 * 
	 * 
	 * @Test public void amountNotGreaterThanBalance() { //Testing withdrawal
	 * amounts are not greater than balances, so there cannot be negative balances
	 * after withdrawing. UAT 5.5
	 * 
	 ...
	 * 
	 * 
	 * @Test public void notEmpty() { //Testing withdrawals do not contain empty
	 * values. UAT 5.6 Withdrawal newWithdrawal = new
	 * Withdrawal("O1001","A1001","");
	 * Assert.assertEquals("Withdrawal amount cannot be empty",
	 * newWithdrawal.validateWithdrawalAmount(newWithdrawal.getWithdrawalAmount()));
	 * }
	 * 
	 * @Test public void testWithdrawalAmountIsNumeric() { //Testing withdrawals do
	 * not contain any char or string data. UAT 5.7 Withdrawal withdrawal1 = new
	 * Withdrawal ("O1002","A1004","23w");
	 ...
	 * withdrawal1.validateWithdrawalAmount(withdrawal1.getWithdrawalAmount())); }
	 * 
	 * @Test public void testwithdrawalAmountMustBeDollarsAndCents () { //Testing
	 * withdrawals do not contain more than two decimal places. UAT 5.8 Withdrawal
	 * withdrawal1 = new Withdrawal ("O1002","A1004","1.234");
	 ...
	 * withdrawal1.validateWithdrawalAmount(withdrawal1.getWithdrawalAmount())); }
	 * 
	 * @Test public void TestWithdrawalAmountCannotBeBlank() { //Testing withdrawals
	 * do not contain spaces (blanks). UAT 5.9 Withdrawal withdrawal1 = new
	 * Withdrawal ("O1002","A1004"," ");
	 * Assert.assertEquals("Withdrawal amount cannot be blank",
	 * withdrawal1.validateWithdrawalAmount(" ")); withdrawal1 = new Withdrawal
	 * ("O1002","A1004","      ");
	 * Assert.assertEquals("Withdrawal amount cannot be blank",
	 * withdrawal1.validateWithdrawalAmount(" ")); withdrawal1 = new Withdrawal
	 * ("O1002","A1004","50.00"); Assert.assertEquals("valid",
	 * withdrawal1.validateWithdrawalAmount(withdrawal1.getWithdrawalAmount())); }
	 * 
	 * @Test public void TestWithdrawalAmountCannotBeZero() { //Testing withdrawals
	 * do not contain a zero amount. UAT 5.10 Withdrawal withdrawal1 = new
	 * Withdrawal ("O1002","A1004","0.00");
